...
Quiz_q* __InitQuestion(unsigned int quizId,unsigned int mark,char* question,Quiz_r* answers)
{
...
void __AddQuestion(Quiz_q** questions,unsigned int quizId,unsigned int mark,char* question,Quiz_r* answers)
{
	...
	if(!*questions)
	{
		*questions=__InitQuestion(quizId,mark,question,answers);
		return;
	}
